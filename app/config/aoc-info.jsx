...
const bandInfo = {
    band_logo: e2,
    band_name: 'Architect of Chaos',
    band_name_full: 'Architect of Chaos',
    ...
    FEATURED_TRACK: {
        ...
        audioSrc: "/audio/aoc/created-a-monster/new-beginning-feature.mp3",
    ...
    ALBUMS: [
        {
            ...
            tracks: [
                {
                    title: "Created A Monster",
                    audioSrc: "/audio/aoc/created-a-monster/created-a-monster-demo.mp3",
                    songImg: "",
                    storyBehindTheLyrics: "",
                    releaseDate: "12/05/2025"
                },
                {title: "Angels", audioSrc: "/audio/aoc/created-a-monster/angels.mp3", releaseDate: ""},
                {
                    title: "Blown Away",
                    audioSrc: "/audio/aoc/created-a-monster/blown-away.mp3",
                    songImg: "",
                    storyBehindTheLyrics: "",
                    releaseDate: "12/23/2025"
                },
                {title: "Lost and Afraid", audioSrc: "/audio/aoc/created-a-monster/lost-and-afraid.mp3", releaseDate: ""},
                {title: "Tell Me", audioSrc: "/audio/aoc/created-a-monster/tell-me.mp3", releaseDate: ""},
                {title: "Running Away", audioSrc: "/audio/aoc/created-a-monster/running-away.mp3", releaseDate: ""},
                {title: "Friends", audioSrc: "/audio/aoc/created-a-monster/friends.mp3", releaseDate: ""},
                {title: "Fully Alive", audioSrc: "/audio/aoc/created-a-monster/fully-alive.mp3", releaseDate: ""},
                {title: "No More Games", audioSrc: "/audio/aoc/created-a-monster/no-more-games.mp3", releaseDate: ""},
                {
                    title: "Passion",
                    audioSrc: "/audio/aoc/created-a-monster/passion.mp3",
                    songImg: "",
                    storyBehindTheLyrics: "",
                    releaseDate: "12/22/2025"
                },
                {title: "Hold My Hand", audioSrc: "/audio/aoc/created-a-monster/hold-my-hand.mp3", releaseDate: ""},
                {title: "Ugly", audioSrc: "/audio/aoc/created-a-monster/ugly.mp3", releaseDate: ""},
            ]
        },
        {
            ...
            tracks: [
                { title: "Brand New Day", audioSrc: "/audio/aoc/wake-of-determination/brand-new-day.mp3", releaseDate: ""  },
                { title: "Wake of Determination", audioSrc: "/audio/aoc/wake-of-determination/wake-of-determination.mp3", releaseDate: ""  },
            ],
        },
        ],
